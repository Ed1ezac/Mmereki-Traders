                ...
                <div class="px-6 py-2 space-y-6 sm:p-6">
                    ...
                    <div class="flex justify-between items-center">
                        <div class="inline-flex items-center">
                            <input id="remember" name="remember" type="checkbox" class="h-4 w-4 text-gray-800 focus:ring-2 focus:ring-gray-800 border-gray-300 rounded">
                    ...
                    <!---button-->
                    <div>
                        <button type="submit" class="group relative w-full flex justify-center py-2 px-4 mb-3 my-btn border-transparent bg-gray-500 hover:bg-gray-700 focus:outline-none focus:ring-gray-800">
