...
<section class="hero">
    <div class="flex flex-col items-center">
        ...
        <div class="flex justify-center mx-4 my-8 lg:mt-24">
            <a class="inline-flex items-center text-primary-200 hover:text-primary-300 my-link group no-underline text-lg font-medium mr-7 sm:mr-16 hover:underline" href="/terms">
            ...
            <a class="inline-flex items-center text-primary-200 hover:text-primary-300 my-link text-lg font-semibold" href="/about">
                <span class="mr-2.5 flex items-center">
                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a class="inline-flex items-center text-primary-200 hover:text-primary-300 my-link no-underline text-lg font-medium ml-7 sm:ml-16 hover:underline" href="/privacy-policy">
                <span class="mr-2.5 flex items-center">
                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
