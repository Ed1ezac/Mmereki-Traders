...
<section>
    <div class="sm:h-80 bg-primary-600 -mt-4 z-0 px-16">
        ...
        <div class="flex items-end  h-full max-w-7xl 2xl:mx-auto">
            <div class="flex flex-col">
                <div class="flex flex-col items-start sm:items-end pt-14 sm:pt-0 sm:flex-row">
                    ...
                    <div class="flex flex-col justify-center space-y-2 sm:mx-8">
                        ...
                        <div class="flex items-center">
                            ...
                            <h5 class="text-xl text-white">{{ $company->location->name }}</h5>
                        </div>
                ...
                <div class="mt-6 p-1 text-sm rounded-t-md border-b border-primary-600 font-semibold bg-primary-100 text-primary-800">
                    Please mention <span class="font-bold">Mmereki</span> when you contact the trade.
                </div>
            </div>
        </div>
